  ...
  return (
    <section className="py-10 md:py-16">
      ...
      className="container text-center">
        <div className="max-w-screen-md mx-auto">
          ...
          animate='end'
            className="text-sm uppercase tracking-wider
                bg-secondary/50 text-secondary-foreground max-w-max
                mx-auto px-3 py-1 rounded-full border-t border-blue-500/10 backdrop-blur-3xl mb-6 md:mb-10"
          >
          ...
          variants={heroChildVariant}
            className="text-4xl font-semibold !leading-tight
                mb-4 md:text-5xl md:mb-5 lg:text-6xl"
          >
            ...
            <span className="relative isolate ms-4">
              ...
              <span
                className="absolute -z-10 top-2 -left-6
                        -right-4 bottom-0.5 bg-foreground/5 rounded-full
        ...
        <div
          className="relative mt-12 max-w-screen-xl mx-auto
            isolate rounded-xl md:mt-16"
        >
          <motion.figure
