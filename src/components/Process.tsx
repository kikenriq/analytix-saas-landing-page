  ...
  return (
    <section className="section">
      <div className="container">
        ...
        <div className='grid gap-14 lg:items-center
        lg:grid-cols-2'>
            <div className='grid gap-7 lg:gap-10'>
                {processData.list.map(({ icon, text, title }, index) => (
                        ...
                        >
                            <motion.div 
                            className='size-16 grid place-items-center rounded-full border 
                            border-foreground/5 shrink-0'
            ...
            <div className='max-lg:-order-1'>
               ...
               rounded-3xl max-w-[580px] overflow-hidden p-8 !pb-0
               lg:p-12 '>
                    <img 
                    src={processBanner}
                    width={500}
